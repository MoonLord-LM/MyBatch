...
powershell -NoProfile -Command "Write-Host '视频编码转换为 h264 格式（默认质量 -crf 23 -preset medium）' -ForegroundColor Green"
        ...
        if "!is_h264!"=="1" (
            ...
            if exist "!output_file!" (
                ...
                if "!need_convert!"=="1" (
                    ...
                    ffmpeg -i "!video_file!" -c:v libx264 -crf 23 -preset medium -c:a flac -compression_level 8 "!output_file!"
                    if !errorlevel! neq 0 (
