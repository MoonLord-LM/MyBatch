...
powershell -NoProfile -Command "Write-Host '将视频按内置的生成时间，重命名为 VID_YYYYMMDD_HHMMSS 格式，默认使用系统时区' -ForegroundColor Green"
