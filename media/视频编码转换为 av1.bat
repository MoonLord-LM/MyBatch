        ...
        if "!is_av1!"=="1" (
            ...
            if exist "!output_file!" (
                ...
                if "!need_convert!"=="1" (
                    ...
                    ffmpeg -i "!video_file!" -c:v libsvtav1 -crf 24 -preset 2 -c:a flac -compression_level 8 "!output_file!"
                    if !errorlevel! neq 0 (
                    ...
                    ffmpeg -i "!video_file!" -c:v libsvtav1 -crf 24 -preset 2 -c:a copy "!output_file!"
                    if !errorlevel! neq 0 (
                        echo set /a "failed+=1">> "!temp_set!"
                        if exist "!output_file!" ( del /f /q "!output_file!" )
                        echo 转换失败
