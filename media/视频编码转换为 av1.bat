...
powershell -NoProfile -Command "Write-Host '视频编码转换为 av1 格式（默认质量 -crf 30 -preset 6）' -ForegroundColor Green"
        ...
        if "!is_av1!"=="1" (
            ...
            if exist "!output_file!" (
                ...
                if "!need_convert!"=="1" (
                    ...
                    ffmpeg -i "!video_file!" -c:v libsvtav1 -crf 30 -preset 6 -c:a flac -compression_level 8 "!output_file!"
                    if !errorlevel! neq 0 (
