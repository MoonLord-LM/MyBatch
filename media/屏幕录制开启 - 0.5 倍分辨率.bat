...
goto :after_powershell_block
    ...
    $psi.Arguments = '-y -f gdigrab -framerate 30 -draw_mouse 1 -i desktop -vf scale=iw/2:ih/2 -c:v libx265 -crf 22 -preset slower -pix_fmt yuv420p -movflags +faststart ' + $env:output_file;
