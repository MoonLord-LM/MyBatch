...
set "record_args=-y -f gdigrab -framerate 20 -draw_mouse 1 -i desktop -s !record_size! -c:v libx264 -preset veryfast -crf 18 -pix_fmt yuv420p -movflags +faststart ""!output_file!"""
