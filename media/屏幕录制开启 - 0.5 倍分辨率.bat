...
goto :after_powershell_block
    ...
    $psi.Arguments = '-y -f gdigrab -framerate 30 -draw_mouse 1 -i desktop -vf scale=iw/2:ih/2 -c:v libx264rgb -preset ultrafast -crf 0 -pix_fmt bgra -movflags +faststart ' + $env:output_file;
