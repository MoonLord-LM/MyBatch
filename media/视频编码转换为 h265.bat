        ...
        if "!is_h265!"=="1" (
            ...
            if exist "!output_file!" (
                ...
                if "!need_convert!"=="1" (
                    ...
                    "!ffmpeg_path!" -i "!param1!" -c:v libx265 -crf 22 -preset slower -c:a flac -compression_level 8 "!output_file!"
                    if !errorlevel! neq 0 (
                    ...
                    "!ffmpeg_path!" -i "!param1!" -c:v libx265 -crf 22 -preset slower -c:a copy "!output_file!"
                    if !errorlevel! neq 0 (
                        if exist "!output_file!" ( del /f /q "!output_file!" )
                        echo 转换失败
                    ) else (
