...
powershell -NoProfile -Command "Write-Host '视频编码转换为 av1 格式（高质量 -crf 16 -cpu-used 1）' -ForegroundColor Green"
powershell -NoProfile -Command "Write-Host '使用 libaom-av1 编码器，色彩范围完整，但是速度较慢' -ForegroundColor Green"
